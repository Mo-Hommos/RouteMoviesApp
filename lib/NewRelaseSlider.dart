...
class NewRelaseSlider extends StatelessWidget {
  Future<List<trendingMovie>> topRatedData;
  NewRelaseSlider({required this.topRatedData});

  @override
  Widget build(BuildContext context) {
    return FutureBuilder(future: topRatedData, builder: (context, snapshot) {
      if(snapshot.hasData){
        return Column(
              ...
              child: ListView.builder(scrollDirection: Axis.horizontal,itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: Stack(
                    ...
                    children: [
                      GestureDetector(
                        child: Image.network(filterQuality: FilterQuality.high,
                            fit: BoxFit.fill,
...
// Padding(
// padding: const EdgeInsets.all(8.0),
// child: Text("New Releases",style: GoogleFonts.aBeeZee(color: Colors.white),),
// ),
// Container(
// height: 200,
// width: double.infinity,
